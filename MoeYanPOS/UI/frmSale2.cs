    ...
    public partial class frmSale2 : Form
    {
        ...
        public frmSale2()
        {
            try
            {
                ...
                int vouno2;
                vouno2 = 1;
                txtSystemVoucherNo.Text = Convert.ToString(Int64.Parse(txtSystemVoucherNo.Text) + vouno2);
                txtVoucherNo.Text = txtSystemVoucherNo.Text;
        ...
        private void dgvSale_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    txtPendingForm3_Click(sender, e);
                }
        ...
        private void txtPendingForm3_Click(object sender, EventArgs e)
        {
